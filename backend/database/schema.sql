...
CREATE TABLE IF NOT EXISTS csv_imports(id TEXT PRIMARY KEY, file_name TEXT NOT NULL, imported_at TEXT NOT NULL, row_count INTEGER NOT NULL, period_start TEXT NOT NULL, period_end TEXT NOT NULL, aggregate_json TEXT NOT NULL, raw_csv TEXT NOT NULL);
