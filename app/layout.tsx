...
import "./globals.css";
import "./import.css";
const title="QEI Knowledge Intelligence";
const description="A project-aware QE knowledge assistant with governed evidence, authority ranking, citations and safe fallback.";
